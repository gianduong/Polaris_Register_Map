...
//     var
//       //#region add register form
//       emailLabel = document.querySelector('#loginEmailLabel'),
//       email = document.querySelector('#loginEmail'),
//       useNameLabel = document.querySelector('#loginUserNamelLabel'),
//       userName = document.querySelector('#loginUserName'),
//       phoneLabel = document.querySelector('#loginPhoneLabel'),
//       phone = document.querySelector('#loginPhone'),
//       addressLabel = document.querySelector('#loginAddressLabel'),
//       address = document.querySelector('#loginAddress'),
...
//     var activeElement, curEmailIndex, screenCenter, svgCoords,
//       emailCoords, emailScrollMax, chinMin = .5, dFromC, mouthStatus = "small", blinking, eyeScale = 1, eyesCovered = false, showPasswordClicked = false;
...
//       activeElement = "email";
//     }
//     function onAddressLabelClick(e) {
//       activeElement = "address";
//     }
//     function onPhoneLabelClick(e) {
//       activeElement = "phone";
//     }
...
//             <p className="helper helper1">Nguyễn GIản Dương</p>
//           </div>
//           <div className="inputGroup inputGroup1">
//             <label for="loginEmail" id="loginEmailLabel">Phone</label>
//             <input type="email" id="loginEmail" maxlength="254" />
//             {/* <p className="helper helper1">email@domain.com</p> */}
//           </div>
//           <div className="inputGroup inputGroup1">
//             <label for="loginEmail" id="loginEmailLabel">Address</label>
//             <input type="email" id="loginEmail" maxlength="254" />
//             {/* <p className="helper helper1">email@domain.com</p> */}
//           </div>
//           <div className="inputGroup inputGroup1">
